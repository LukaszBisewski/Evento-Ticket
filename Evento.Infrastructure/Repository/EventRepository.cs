...
namespace Evento.Infrastructure.Repositories
{
    public class EventRepository : IEventRepository
    {
        ...
        public async Task<IEnumerable<Event>> BrowseAsync(string name = "") //przyjmuje ocjonalny parametr name i jeżeli podamy nazwę lub wycinek nazwy wykonując operację contains sprawdzamy czy Event zawiera wycinek z parametru name
        {
